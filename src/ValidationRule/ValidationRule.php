...
use IkonizerCore\ValidationRule\ValidationRuleInterface;
use IkonizerCore\ValidationRule\Exception\ValidationBadMethodCallException;
use IkonizerCore\ValidationRule\Exception\ValidationInvalidArgumentException;
            ...
            foreach ($rulePieces as $rulePiece) {
                ...
                return array_walk($rulePieces, function ($callback) {
                    if ($callback) {
                        ...
                        $classRule = '\IkonizerCore\ValidationRule\Rules\\' . Stringify::studlyCaps($method);
                        if (!method_exists(
                            $classRule, 
