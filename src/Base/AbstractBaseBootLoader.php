...
use IkonizerCore\Cache\CacheFacade;
use IkonizerCore\Themes\ThemeBuilder;
use IkonizerCore\Base\BaseApplication;
use IkonizerCore\Logger\LoggerFactory;
use IkonizerCore\Router\RouterFactory;
use IkonizerCore\Session\SessionFacade;
use IkonizerCore\Base\Traits\BootstrapTrait;
use IkonizerCore\Container\ContainerFactory;
use IkonizerCore\ThemeBuilder\ThemeBuilderFactory;
use IkonizerCore\Session\GlobalManager\GlobalManager;
use IkonizerCore\Utility\Singleton;
...
abstract class AbstractBaseBootLoader extends Singleton
{
     ...
     * PHP and IkonizerCore framework is being used at all time in sync.
     *
     * @return void
     */
    ...
    {
        $cache = (new CacheFacade())->create($this->application->getCacheIdentifier(), \IkonizerCore\Cache\Storage\NativeCacheStorage::class);
