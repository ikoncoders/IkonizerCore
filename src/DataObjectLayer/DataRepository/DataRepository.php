...
use Throwable;
use IkonizerCore\Utility\Sortable;
use IkonizerCore\Utility\Paginator;
use IkonizerCore\DataObjectLayer\EntityManager\EntityManager;
use IkonizerCore\DataObjectLayer\EntityManager\EntityManagerInterface;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function or404(): ?object
    {
        if ($this->findAndReturn != null) {
            ...
            // $template = new \IkonizerCore\Base\BaseView();
