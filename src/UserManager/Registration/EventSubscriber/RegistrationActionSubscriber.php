...
namespace IkonizerCore\UserManager\Registration\EventSubscriber;

use IkonizerCore\UserManager\Registration\Event\RegistrationActionEvent;
...
use IkonizerCore\Mailer\Exception\MailerException;
use IkonizerCore\Mailer\MailerFacade;
