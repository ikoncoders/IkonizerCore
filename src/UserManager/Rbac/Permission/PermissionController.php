...
use IkonizerCore\UserManager\Rbac\Permission\PermissionForm;
use IkonizerCore\Base\Exception\BaseInvalidArgumentException;
use IkonizerCore\UserManager\Rbac\Permission\PermissionEntity;
use IkonizerCore\UserManager\Rbac\Permission\PermissionSchema;
use IkonizerCore\UserManager\Rbac\Permission\Event\PermissionActionEvent;

class PermissionController extends \IkonizerCore\Administrator\Controller\AdminController
{
